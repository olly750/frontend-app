...
import { IntakeModuleMaterialAttachment } from '../../types/services/module-material.types';
...
function NewIntakeModuleMaterialAttach() {
  ...
  const { mutateAsync, isLoading: isAddingMaterial } =
    moduleMaterialStore.addIntakeModuleMaterialAttachment();
          ...
          mutateAsync(
            {
              ...
              intake_academic_program_level_module_materials_id: parseInt(material?.id + ''),
            },
...
export default NewIntakeModuleMaterialAttach;
