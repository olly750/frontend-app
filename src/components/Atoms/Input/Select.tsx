...
export default function Select({
  ...
  useEffect(() => {
    let selected = options.find((op) => op.value == internalValue);
    handleChange({ name, value: internalValue, label: selected?.label });
          ...
          <div
            ...
            <div className="static">
              {filtered.map((op) => (
                ...
                <div
                  key={op.subLabel ? op.value + op.subLabel : op.value}
                  ...
                  {capitalizeLabelAndValue ? op.label.toLocaleUpperCase() : op.label}
                </div>
              ))}
