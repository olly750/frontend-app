  ...
  useEffect(() => {
    setnationality({
      ...
      birth:
        ...
        userInfo.person?.place_of_birth ||
        user.data?.data.data.person?.place_of_birth,
      residence:
        //@ts-ignore
        userInfo.place_of_residence ||
        userInfo.person?.place_of_residence ||
        user.data?.data.data.person?.place_of_residence,
    });
  }, [
    //@ts-ignore
    userInfo.place_of_birth,
            ...
            {personalDetails.doc_type == DocType.PASSPORT && (
              <DateMolecule
                ...
                defaultValue={
                  ...
                  user.data?.data.data.person?.document_expire_on
                }
          ...
          <div>
            ...
            <DateMolecule
              ...
              defaultValue={
                ...
                user.data?.data.data.person?.birth_date
              }
